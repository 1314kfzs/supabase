...
const mockProjects: Project[] = [
  ...
  },
  {
    ...
    technologies: ['React', 'D3.js', 'TypeScript', 'React Spring', 'Webpack'],
    status: 'in-progress',
    start_date: '2023-02-01',
    end_date: undefined,
    github_url: 'https://github.com/nivo/nivo',
    demo_url: 'https://nivo.rocks/',
    featured: false,
...
export const useProjectWithFallback = (id: string) => {
  return useQuery({
    queryKey: ['project-with-fallback', id],
    queryFn: async () => {
      try {
